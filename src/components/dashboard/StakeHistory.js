...
function createData(srNo, Date, UserID, UserName, Amount, Type) {
  return { srNo, Date, UserID, UserName, Amount, Type };
}
...
const rows = [
  createData(
    ...
    "poornapoornima573@gmail.com",
    "Poornima M Shadakshrimath",
    3000,
    "New"
  ),
  createData(
  ...
  return (
    <div>
      <div className="d-flex align-items-center mb-4">
        <h5 className="nameDashboard">All Report</h5>
        <OtherHousesIcon className="forgetPass mx-2" />
        <span>
          <ArrowForwardIosIcon className="listHeading mx-2" />
        </span>
        <h6 className="forgetPass mb-0">Staking History</h6>
      </div>
      <div className="p-2">
        <div className="card">
          <div className="card-header">
            <h5 className="forgetPass">STAKING HISTORY</h5>
          </div>

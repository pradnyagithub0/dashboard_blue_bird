...
const rows = [createData(1, "2/24/2024 3:27:12 PM", 30694.6, "completed")];
  ...
  return (
    <div>
      <div className="d-flex align-items-center mb-4">
        ...
        <h6 className="forgetPass mb-0">Royalty Reward</h6>
      </div>
      <div className="p-2">
        <div className="card">
          <div className="card-header">
            <h5 className="forgetPass">ROYALTY REWARD</h5>
          </div>

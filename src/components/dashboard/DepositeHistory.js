...
function createData(srNo, Date, BLBM, Status) {
  return { srNo, Date, BLBM, Status };
}
...
const rows = [
  ...
  createData(4, "2/24/2024 3:27:12 PM", 600, "Credited"),
  createData(5, "2/24/2024 3:27:12 PM", 600, "Credited"),
  createData(6, "2/24/2024 3:27:12 PM", 600, "Credited"),
];
  ...
  return (
    <div>
      <div className="d-flex align-items-center mb-4">
        <h5 className="nameDashboard">Deposite History</h5>
        <OtherHousesIcon className="forgetPass mx-2" />
        <span>
          <ArrowForwardIosIcon className="listHeading mx-2" />
        </span>
        <h6 className="forgetPass mb-0">Deposite History</h6>
      </div>
      <div className="p-2">
        <div className="card">
